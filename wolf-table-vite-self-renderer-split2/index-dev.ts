...
// set cell
t1.cell(2, 2, { value: 'set-value', style: si });
t1.cell(15, 7, {
  type: 'text',
  value: 'option',
  options: async (q) =>
...
// get cell
console.log('cell[2,2]:', t1.cell(2, 2));
...
t2.set_sync_data(t1.data());
t2._cells = t1._cells;
t2.render();
t1.set_sync_table(t2);
t2.set_sync_table(t1);
