<script lang="ts">
  ...
  $: xcolumns =
    endX > columns.length ? Array.from({ length: endX - columns.length }, (v, i) => ({})) : [];
...
<div class="sticky_table_wrapper">
  ...
  >
    ...
    >
      <div class="top-extend absolute" class:hidden={!extension} bind:this={topextend} />
      <div class="bottom-extend absolute" class:hidden={!extension} bind:this={bottomextend} />
      <div class="left-extend absolute" class:hidden={!extension} bind:this={leftextend} />
      <div class="right-extend absolute" class:hidden={!extension} bind:this={rightextend} />
                ...
                >
                  {#if String(edition) == String([x.i, r.i])}
                    <input
                      ...
                      on:keydown={(e) => onInputKeyDown(e, r, x)}
