...
export const computeStyles = (c, r, row, style, options, value, nextValue) => {
  ...
  */
  ...
  if ( c > 1 && c < 6 && r > 10 && r < 14)  {
    ...
    if        ( c==2       && r ==11) {            //  top-left
	  _style += "border-top    :4px  blue  solid;";
	  _style += "border-bottom :2px  blue  solid;";
	  _style += "border-left   :4px  blue  solid;";
	  _style += "border-right  :2px  blue  solid;";
    } else if ( c==5       && r ==11) {            //  top-right
	  _style += "border-top    :4px  blue  solid;";
	  _style += "border-bottom :2px  blue  solid;";
	  _style += "border-left   :2px  blue  solid;";
	  _style += "border-right  :4px  blue  solid;";
    } else if ( c>2 && c<5 && r ==11) {            //  top-mid
	  _style += "border-top    :4px  blue  solid;";
	  _style += "border-bottom :2px  blue  solid;";
	  _style += "border-left   :2px  blue  solid;";
	  _style += "border-right  :2px  blue  solid;";
    } else if ( c==2       && r ==13) {            //  bottom-left
	  _style += "border-top    :2px  blue  solid;";
	  _style += "border-bottom :4px  blue  solid;";
	  _style += "border-left   :4px  blue  solid;";
	  _style += "border-right  :2px  blue  solid;";
    } else if ( c==5       && r ==13) {            //  bottom-right
	  _style += "border-top    :2px  blue  solid;";
	  _style += "border-bottom :4px  blue  solid;";
	  _style += "border-left   :2px  blue  solid;";
	  _style += "border-right  :4px  blue  solid;";
    } else if ( c>2 && c<5 && r ==13) {            //  bottom-mid
	  _style += "border-top    :2px  blue  solid;";
	  _style += "border-bottom :4px  blue  solid;";
	  _style += "border-left   :2px  blue  solid;";
	  _style += "border-right  :2px  blue  solid;";
    } else if ( c==2 && r>11 && r<13) {            //  left-mid
	  _style += "border-top    :2px  blue  solid;";
	  _style += "border-bottom :2px  blue  solid;";
	  _style += "border-left   :4px  blue  solid;";
	  _style += "border-right  :2px  blue  solid;";
    } else if ( c==5 && r>11 && r<13) {            //  right-mid
	  _style += "border-top    :2px  blue  solid;";
	  _style += "border-bottom :2px  blue  solid;";
	  _style += "border-left   :2px  blue  solid;";
	  _style += "border-right  :4px  blue  solid;";
